 ...
 */
typedef VOID (*FREE_ITEM_FUNCTION) (PHASH_ITEM Object, PVOID FreeContext);
...
typedef struct _HASH_TABLE {
	...
	/** An user-defined value passed to the hash table. */
	PVOID FreeContext;
	/** The buckets. */
...
NTSTATUS HashTableCreate(EHashTableType Type, ULONG32 Size, HASH_FUNCTION HashFunction, COMPARE_FUNCTION CompareFunction, FREE_ITEM_FUNCTION FreeFunction, PHASH_TABLE *Table);
