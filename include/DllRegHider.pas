...
Function PseudoValueSet(AKeyName:PWideChar; AValueName:PWideChar; AValueType:Cardinal; AData:Pointer; ADataLength:Cardinal; ADeleteMode:ERegistryValueOpMode; AChangeMode:ERegistryValueOpMode; AProcessName:PWideChar):Cardinal; StdCall;
...
Function PseudoValueSet(AKeyName:PWideChar; AValueName:PWideChar; AValueType:Cardinal; AData:Pointer; ADataLength:Cardinal; ADeleteMode:ERegistryValueOpMode; AChangeMode:ERegistryValueOpMode; AProcessName:PWideChar):Cardinal; StdCall; External LibraryName;
...
Function PseudoValueSet(AKeyName:PWideChar; AValueName:PWideChar; AValueType:Cardinal; AData:Pointer; ADataLength:Cardinal; ADeleteMode:ERegistryValueOpMode; AChangeMode:ERegistryValueOpMode; AProcessName:PWideChar):Cardinal; StdCall; External LibraryName name '_PseudoValueSet@32';
